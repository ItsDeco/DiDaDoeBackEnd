...
function Home() {
  ...
  return (
    <>
      ...
      <div className="mobile-bottom-buttons"> {/* Mobile Bottom Buttons */}
        <button 
          className="mobile-github-button"
          onClick={() => window.open('https://github.com/ItsDeco/DiDaDoeBackEnd', '_blank')}
        ...
        <button className="mobile-rules-button" onClick={openRulesModal}>
          How to play
        </button>
      </div>
